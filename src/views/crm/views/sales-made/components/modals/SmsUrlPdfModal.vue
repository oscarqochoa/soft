<template>
  <b-modal v-model="ownControl" title="Send SMS" hide-footer @hide="$emit('closeModal')">
    <b-container fluid>
      <b-row>
        <b-col class="d-flex align-items-center">
          <span>Leads:</span>
          <div class="ml-1">{{ nameleads }}</div>
        </b-col>
      </b-row>
      <b-row class="mt-1">
        <b-col>
      ...
      <b-row class="mt-1">
        <b-col>
          <span v-if="maxLenght" class="text-danger">Max: 1000 characters</span>
        </b-col>
      ...
      <b-row class="mt-1">
        ...
        <b-col v-if="modul == 15">
          <b-input-group size="sm">
            ...
            <b-form-input placeholder="Nickname" readonly />
          </b-input-group>
        </b-col>
      </b-row>
    </b-container>
