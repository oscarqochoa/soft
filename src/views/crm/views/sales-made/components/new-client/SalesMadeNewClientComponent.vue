      ...
      >
        ...
        <template #custom-foot>
          ...
          <b-tr>
            ...
            <b-td colspan="2" class="text-center">{{ '$ ' + subtotal.tcmc }}</b-td>
            <b-td colspan="2" class="text-center">{{ '$ ' + subtotal.tcms }}</b-td>
            <b-td colspan="3" class="text-center">{{ '$ ' + subtotal.tfee }}</b-td>
            <b-td colspan="3" class="text-center">{{ '$ ' + subtotal.tip }}</b-td>
            <b-td colspan="2" class="text-center">{{ '$ ' + subtotal.tma }}</b-td>
            <b-td :colspan="done === 0 ? 3 : 2" />
          </b-tr>
          <b-tr>
  ...
  methods: {
    ...
    async updateRow() {
      ...
      Object.assign(
        ...
        this.newRowFromSelectedIndex.data[0]
      );
    },
