    ...
    <label :for="source" style="width: 100%" @click="isSingle">
      ...
      >
        <div v-show="!images.length">
          <img src="/assets/images/drag-drop/folder-icon.png" class="mb-3 mt-5" alt />
          ...
          <div class="file-input">
            <div class="file-input roboto-class" style="font-weight: bold; font-size: 20px">
        ...
        >
          ...
          >
            ...
            <div class="details">
              <span class="name" v-text="files[index].name.substr(0, 10)"></span>
              <span class="size" v-text="getFileSize(files[index].size)"></span>
              <button
                @click="removeFile($event, index)"
                style="position: absolute; top: 5px; right: 7px"
              >
                <img style="width: 85%" :src="'/assets/images/drag-drop/trash.ico'" />
              </button>
            </div>
          </div>
        </div>
