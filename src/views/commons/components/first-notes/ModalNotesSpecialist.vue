<template>
  ...
  >
    <template #modal-header>
      <HeaderModalNotes program="Specialist" :info="noteInfo" @close="hideModal(false)" />
    </template>
    <ValidationObserver ref="form">
      <b-row>
        <b-col>
          <b-form-group label="Type of Services" label-class="font-weight-bolder">
            <validation-provider v-slot="{ errors }" name="typeOfServices" rules="required">
              <b-form-radio-group
      ...
      <b-row v-if="note.typeOfServices.value === '1'" class="mt-1">
        <b-col cols="5">
          <b-form-group label-class="font-weight-bolder" label="Previous ID Numbers">
            <validation-provider v-slot="{ errors }" name="previousIdNumbers" rules="required">
              <b-form-radio-group
          ...
          <b-form-group label="Time" label-class="font-weight-bolder" label-cols="2">
            <validation-provider v-slot="{ errors }" name="previousIdNumbersTime" rules="required">
              <b-form-input
        ...
        <b-col cols="2" class="font-weight-bolder d-flex align-items-center">TO</b-col>
        <b-col cols="5">
          <b-form-group label-class="font-weight-bolder" label="Current ID Numbers">
            <validation-provider v-slot="{ errors }" name="currentIdNumbers" rules="required">
              <b-form-radio-group
          ...
          <b-form-group label="Time" label-class="font-weight-bolder" label-cols="2">
            <validation-provider v-slot="{ errors }" name="currentIdNumbersTime" rules="required">
              <b-form-input
      ...
      <b-row v-else-if="note.typeOfServices.value === '2'" class="mt-1">
        <b-col cols="5">
          <b-form-group label="ID Type Number" label-class="font-weight-bolder">
            <validation-provider v-slot="{ errors }" name="idTypeNumber" rules="required">
              <b-form-radio-group
        ...
        <b-col>
          <validation-provider v-slot="{ errors }" name="studentLoanType" rules="required">
            <b-form-group label="Student Loan Type" label-class="font-weight-bolder">
              <b-form-radio-group
        ...
        <b-col>
          <b-form-group label-class="font-weight-bolder" label="Amount Owed">
            <validation-provider v-slot="{ errors }" name="amountOwed" rules="required">
              <money
      ...
      <b-row>
        <b-col>
          <validation-provider v-slot="{ errors }" name="inconvenience" rules="required">
            <b-form-group label="Inconvenience" label-class="font-weight-bolder">
              <quill-editor
      ...
      <b-row>
        <b-col>
          <validation-provider v-slot="{ errors }" name="recommendations" rules="required">
            <b-form-group label="Recommendations" label-class="font-weight-bolder">
              <quill-editor
      ...
      note.forEach(answer => {
        if (answer.answer != "null") {
          ...
          if (answer.question_id === 1038)
            this.note.amountOwed.value = answer.answer;
