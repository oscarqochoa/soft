<template>
  ...
  >
    <template #modal-header>
      <header-modal-notes program="Tax Research" :info="noteInfo" @close="hideModal(false)" />
    </template>
    <validation-observer ref="form">
      <b-row>
        <b-col md="9">
          <b-form-group label="Marital Status" label-class="font-weight-bolder">
            <validation-provider v-slot="{ errors }" name="maritalStatus" rules="required">
              <b-form-radio-group
        ...
        <b-col md="2">
          <b-form-group label="Dependents" label-class="font-weight-bolder" :disabled="disabled">
            <validation-provider v-slot="{ errors }" name="dependents" rules="required">
              <b-form-input
      ...
      <b-row>
        <b-col md="6">
          <validation-provider v-slot="{ errors }" name="migrationSituation" rules="required">
            <b-form-group label="Migratory Situation" label-class="font-weight-bolder">
              <b-form-radio-group
        ...
        <b-col>
          <validation-provider v-slot="{ errors }" name="bankruptcy" rules="required">
        ...
        <transition name="fade">
          <b-col v-if="note.bankruptcy.value === 'YES'">
            <validation-provider v-slot="{ errors }" name="bankruptcyYear" rules="required">
              <b-form-group label="Bankruptcy Year" label-class="font-weight-bolder">
                <b-form-input
        ...
        <transition name="fade">
          <b-col v-if="note.bankruptcy.value === 'YES'">
            <validation-provider v-slot="{ errors }" name="bankruptcyChapter" rules="required">
      ...
      <b-row>
        <b-col md="3">
          <validation-provider v-slot="{ errors }" name="taxYearsPending" rules="required">
            <b-form-group label="Tax Years pending" label-class="font-weight-bolder">
              <b-form-input
