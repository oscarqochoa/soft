<template>
  ...
  >
    <template #modal-header>
      <header-modal-notes program="Credit Experts" :info="noteInfo" @close="hideModal(false)" />
    </template>
    <validation-observer ref="form">
      <b-row>
        <b-col>
          <validation-provider v-slot="{ errors }" name="identificationNumber" rules="required">
        ...
        <b-col>
          <validation-provider v-slot="{ errors }" name="workStatus" rules="required">
      ...
      <b-row>
        ...
        <b-col>
          <validation-provider v-slot="{ errors }" name="contactSchedule" rules="required">
      ...
      <b-row>
        <b-col>
          <validation-provider v-slot="{ errors }" name="emergencyContact" rules="required">
            <b-form-group label="Emergency Contact" label-class="font-weight-bolder">
              <b-form-input
      ...
      <b-row>
        <b-col>
          <validation-provider v-slot="{errors}" name="goals" rules="required">
      ...
      <b-row>
        <b-col>
          <b-form-group label-class="font-weight-bolder" label="Incoveniences">
            <b-row>
              <b-col>
                <b-table small :items="note.incoveniences.mid1" class="font-small-2" />
              </b-col>
              <b-col>
                <b-table small :items="note.incoveniences.mid2" class="font-small-2" />
              </b-col>
            </b-row>
            <b-row>
              <b-col>
                <validation-provider v-slot="{errors}" rules="required" name="incoveniences">
                  <quill-editor
      ...
      <b-row>
        <b-col>
          <b-form-group label="Recomendations" label-class="font-weight-bolder">
            <validation-provider v-slot="{ errors }" name="recomendationCheckbox" rules="required">
              <b-form-checkbox-group
