<template>
  ...
  >
    <template #modal-header>
      <header-modal-notes program="Bussiness" :info="noteInfo" @close="hideModal(false)" />
    </template>
    <validation-observer ref="form">
      <b-row>
        <b-col>
          <validation-provider v-slot="{ errors }" name="ein" rules="required">
            <b-form-group label="EIN" label-class="font-weight-bolder">
              <b-form-radio-group
        ...
        <b-col>
          <validation-provider v-slot="{ errors }" name="businessIdentification" rules="required">
            <b-form-group label="Business Identification" label-class="font-weight-bolder">
              <b-form-radio-group
        ...
        <b-col v-if="dateTypeAgreement">
          <validation-provider v-slot="{ errors }" name="typeOfAgreement" rules="required">
            <b-form-group label="Type of Agreement" label-class="font-weight-bolder">
              <b-form-radio-group
      ...
      <b-row>
        <b-col>
          <validation-provider v-slot="{ errors }" name="typeOfBusiness" rules="required">
            <b-form-group label="Type of Business" label-class="font-weight-bolder">
              <v-select
      ...
      <b-row>
        <b-col>
          <validation-provider v-slot="{ errors }" name="numberOfEmployees" rules="required">
            <b-form-group label="Number of Employees" label-class="font-weight-bolder">
              <v-select
        ...
        <b-col>
          <validation-provider v-slot="{ errors }" name="annualIncome" rules="required">
            <b-form-group label="Annual Income" label-class="font-weight-bolder">
              <v-select
      ...
      <b-row>
        <b-col md="6">
          <validation-provider v-slot="{ errors }" name="newBusiness" rules="required">
            <b-form-group label-class="font-weight-bolder" label="It a New Business?">
              <b-form-radio-group
        ...
        <transition name="fade">
          <b-col v-if="note.newBusiness.value === 'No'" md="6">
            <validation-provider v-slot="{ errors }" name="startBusiness" rules="required">
              <b-form-group
        ...
        <transition name="fade">
          <b-col v-if="note.newBusiness.value === 'No'" md="6">
            <validation-provider v-slot="{ errors }" name="businessRegistration" rules="required">
              <b-form-group
        ...
        <transition name="fade">
          <b-col
            ...
            md="6"
          >
            <validation-provider v-slot="{ errors }" name="registerBusiness" rules="required">
              <b-form-group
            ...
            <validation-provider v-slot="{ errors }" name="registerBusinessText" rules="required">
              <quill-editor
        ...
        <b-col md="6">
          <validation-provider v-slot="{ errors }" name="originCountry" rules="required">
      ...
      <b-row>
        <b-col>
          <validation-provider v-slot="{ errors }" name="information" rules="required">
      ...
      <b-row>
        <b-col>
          <validation-provider v-slot="{ errors }" name="indications" rules="required">
      ...
      <b-row>
        <b-col>
          <validation-provider v-slot="{ errors }" name="suggestions" rules="required">
...
export default {
  ...
  watch: {
    "note.businessIdentification.value": {
      handler(newValue) {
        if (newValue !== "N/A") {
          this.note.businessIdentification.otherValue = this.note
            .businessIdentification.otherValue
    ...
    getDetailsAnswers(note) {
      note.forEach(answer => {
        ...
        if (answer.answer != "null") {
          ...
          if (answer.question_id === 1003)
            this.note.businessIdentification.otherValue = answer.answer;
          if (answer.question_id === 1012)
            this.note.information.value = answer.answer;
          if (answer.question_id === 1013)
          ...
          if (answer.question_id === 1005)
            this.note.numberOfEmployees.value = answer.answer;
          if (answer.question_id === 1006)
            this.note.annualIncome.value = answer.answer;
          if (answer.question_id === 1068)
            this.note.indications.value = answer.answer;
          if (answer.question_id === 1001) this.note.ein.value = answer.answer;
          if (answer.question_id === 1007)
            this.note.newBusiness.value = answer.answer;
          if (answer.question_id === 1008)
            this.note.newBusiness.startBusiness = answer.answer;
          if (answer.question_id === 1009)
            this.note.newBusiness.registration.value = answer.answer;
          if (answer.question_id === 1010)
            this.note.newBusiness.registerBusiness.value = answer.answer;
          if (answer.question_id === 1011)
            this.note.newBusiness.registerBusiness.text = answer.answer;
