    ...
    >
      ...
      <ValidationObserver ref="form">
        <b-row class="px-1 mt-1">
          <b-col lg="4">
            <ValidationProvider v-slot="{errors}" name="identification" rules="required">
          ...
          <b-col lg="4">
            <ValidationProvider v-slot="{errors}" name="Another" rules="required">
              <b-form-group
          ...
          <b-col lg="4">
            <ValidationProvider v-slot="{errors}" name="Pending" rules="required">
        ...
        <b-row class="mt-1 px-1">
          <b-col v-if="dateTypeAgreement" lg="4">
            <ValidationProvider v-slot="{errors}" name="agreement" rules="required">
          ...
          <b-col lg="4">
            <ValidationProvider v-slot="{errors}" name="Credit" rules="required">
        ...
        <b-row class="mt-1 px-1">
          <b-col lg="4">
            <ValidationProvider v-slot="{errors}" name="Work" rules="required">
          ...
          <b-col lg="4">
            <ValidationProvider v-slot="{errors}" name="Hours" rules="required">
              <b-form-group
                label-class="font-weight-bolder"
          ...
          <b-col lg="4">
            <ValidationProvider v-slot="{errors}" name="TypeDays" rules="required">
              <b-form-group
                label-class="font-weight-bolder"
        ...
        <b-row class="mt-1 px-1">
          <b-col lg="6">
            <ValidationProvider v-slot="{errors}" name="TypGoal" rules="required">
          ...
          <b-col lg="6">
            <ValidationProvider v-slot="{errors}" name="OriginCountry" rules="required">
              <b-form-group
                label-class="font-weight-bolder"
        ...
        <b-row class="mt-1 px-1">
          ...
          <b-col v-if="note.fileAudio" lg="6">
            <audio :src="note.fileAudio" controls class="mt-1 w-100" type="audio/mp3" />
          </b-col>
        </b-row>

        <b-row class="px-1">
          <b-col lg="12">
            <ValidationProvider v-slot="{errors}" name="Inconvenience" rules="required">
              <b-form-group
                label-class="font-weight-bolder"
                label="Inconvenience"
        ...
        <b-row class="mt-1 px-1">
          <b-col lg="12">
            <ValidationProvider v-slot="{errors}" name="Information" rules="required">
              <b-form-group
                label-class="font-weight-bolder"
                label="Information"
        ...
        <b-row class="mt-1 px-1">
          <b-col lg="12">
            <ValidationProvider v-slot="{errors}" name="Recommendations" rules="required">
              <b-form-group
                label-class="font-weight-bolder"
